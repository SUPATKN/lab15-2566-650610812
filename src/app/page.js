...
const schema = z
  ...
  .refine(
    (pass) => {
      if (pass.password !== pass.confirmPassword) return false;
      if (pass.password === pass.confirmPassword) return true;
    },
    {
...
export default function Home() {
  ...
  const computePrice = () => {
    ...
    else if (form.values.plan === "full") price = 500;

    if (form.values.coupon === "CMU2023") price = price * (70 / 100);
